...
\gregorioscore{gabc/or01--in_nomine_patris--solesmes.gabc}

\emph{\vv Au nom du Père, du Fils et du Saint-Esprit.~~~~\rr Amen.}

\gregorioscore{gabc/or02--gratia_domini--solesmes.gabc}
...
\gregorioscore{gabc/01ky--kyrie_iii--solesmes.gabc}
...
\gresetinitiallines{0}
\gregorioscore{gabc/or04--verbum_domini_solesmes.gabc}

\emph{\vv Parole du Seigneur. ~~~~ \rr Nous rendons grâce à Dieu.}

\pagebreak
\gresetinitiallines{1}
\gregorioscore{gabc/gr.gabc}
...
\gresetinitiallines{0}
\gregorioscore{gabc/or05--dominus_vobiscum_..._lectio_sancti_evangelii_(c)--solesmes.gabc}
...
\gregorioscore{gabc/or06--verbum_domini_(c)--solesmes.gabc}
\emph{\vv Parole du Seigneur. ~~~~ \rr Louange à toi, ô Christ.}

\paragraph{Offertoire}

\gresetinitiallines{1}
\gregorioscore{gabc/of.gabc}
...
\gresetinitiallines{0}
\gregorioscore{gabc/or07--dominus_vobiscum_..._sursum_corda_(b._tonus_sollemnis)--solesmes.gabc}
...
\gresetinitiallines{1}
\gregorioscore{gabc/03ky--sanctus_iii--solesmes.gabc}
...
\gresetinitiallines{0}
\gregorioscore{gabc/or08--mysterium_fidei--solesmes.gabc}
...
\gregorioscore{gabc/or09--pater_noster_(a)--solesmes.gabc}
...
\gregorioscore{gabc/or10--quia_tuum--solesmes.gabc}
...
\gregorioscore{gabc/or11--pax_domini--solesmes.gabc}

\emph{\vv Que la paix du Seigneur soit toujours avec vous.\\
\rr Et avec votre esprit.}

\gresetinitiallines{1}
\gregorioscore{gabc/04ky--agnus_dei_iii--solesmes.gabc}
...
\paragraph{Envoi}
\gresetinitiallines{0}
\gregorioscore{gabc/or12--dominus_vobiscum_..._benedicat_(b)--solesmes.gabc}
